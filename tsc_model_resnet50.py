...
def convolutional_block(X, f, filters, stage, block, s = 2):
    ...
    X_shortcut = Conv2D(F3, kernel_size=(1,1), strides=(s,s), padding="valid", kernel_initializer=glorot_uniform(seed=0), name=conv_name_base+"1")(X_shortcut) 
...
if __name__=="__main__":
    ...
    model = ResNet50(input_shape = (32, 32, 3), classes = nClass)
